...
public class AboutDialog extends JDialog {
    ...
    public AboutDialog(Window parent) {
        super(parent, "Informações", ModalityType.DOCUMENT_MODAL);
    ...
    private void initComponents() {
        ...
        container.add(new JLabel("Esse launcher foi desenvolvido exclusivamente para ser usado na network FinalCraft"), "wrap, gapbottom unrel");
        ...
        sourceCodeButton.addActionListener(ActionListeners.openURL(this, "http://finalcraft.com.br/"));
    }
